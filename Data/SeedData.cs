...
namespace HMS.Data
{
    public class SeedData
    {
        ...
        public IEnumerable<PatientInfo> GetPatientInfoList()
        {
            return new List<PatientInfo>
            {
                new PatientInfo { OtherNames = "Mr", Surname = "Tom", DateOfBirth=DateTime.Now, Email="tom@gmail.com", MaritalStatus="Single", BloodGroup="AB+", Gender="Male", Phone="017889977000", Address="California, USA" },
                new PatientInfo { OtherNames = "Mr", Surname = "Bin", DateOfBirth=DateTime.Now, Email="bin@gmail.com", MaritalStatus="Married", BloodGroup="A+", Gender="Male", Phone="017889977000", Address="California, USA" },
                new PatientInfo { OtherNames = "Ms", Surname = "Gaga", DateOfBirth=DateTime.Now, Email="gaga@gmail.com", MaritalStatus="Married", BloodGroup="O+", Gender="Female", Phone="017889977000", Address="California, USA" },
                new PatientInfo { OtherNames = "Mr", Surname = "Trump", DateOfBirth=DateTime.Now, Email="trump@gmail.com", MaritalStatus="Single", BloodGroup="AB+", Gender="Male", Phone="017889977000", Address="California, USA" },
                new PatientInfo { OtherNames = "Ms", Surname = "Clinton", DateOfBirth=DateTime.Now, Email="clinton@gmail.com", MaritalStatus="Single", BloodGroup="AB+", Gender="Female", Phone="017889977000", Address="California, USA" },
            };
        }
