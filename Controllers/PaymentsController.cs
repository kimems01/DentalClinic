...
namespace HMS.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        [Authorize(Roles = Pages.RoleNameList.Payments)]
        ...
        {
            var _PrintPaymentInvoice = await _iCommon.PrintPaymentReport(_PaymentId);
        ...
        public async Task<IActionResult> PrintPaymentReceipt(Int64 _PaymentId)
        {
            var _PrintPaymentReceipt = await _iCommon.PrintPaymentReport(_PaymentId);
            return View(_PrintPaymentReceipt);
        }
        public async Task<IActionResult> ThermalPrintPaymentReceipt(Int64 _PaymentId)
        {
            var _PrintPaymentReceipt = await _iCommon.PrintPaymentReport(_PaymentId);
            return View(_PrintPaymentReceipt);
        }
