...
namespace HMS.Controllers
{
    ...
    public class UserManagementController : Controller
    {
        ...
        [Authorize(Roles = Pages.RoleNameList.UserManagement)]
        public IActionResult IndexAllUser()
        {
            return View();
        }
        [Authorize(Roles = Pages.RoleNameList.Nurse)]
        public IActionResult IndexNurse()
        {
            return View();
        }
        [Authorize(Roles = Pages.RoleNameList.Laboraties)]
        public IActionResult IndexLaboraties()
        {
            return View();
        }
        [Authorize(Roles = Pages.RoleNameList.Accountants)]
        public IActionResult IndexAccountants()
        {
            return View();
        }
        [Authorize(Roles = Pages.RoleNameList.Pharmacist)]
