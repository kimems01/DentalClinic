...
namespace HMS.Controllers
{
    ...
    public class DownloadReportController : Controller
    {
        ...
        [Authorize(Roles = Pages.RoleNameList.Admin)]
        ...
        public async Task<IActionResult> DownloadPaymentReceiptReportPDF(Int64 _PaymentId)
        {
            var _PrintPaymentInvoice = await _iCommon.PrintPaymentReport(_PaymentId);
            var rpt = new ViewAsPdf();
            rpt.PageOrientation = Orientation.Portrait;
            ...
            rpt.FileName = "Payment_Receipt_Report_" + _PaymentId + ".pdf";
            rpt.ViewName = "DownloadPaymentReceiptReportPDF";
            rpt.Model = _PrintPaymentInvoice;
            return rpt;
        }
