$(document).ready(function () {
    ...
    $("#tblProcedures").DataTable({
        ...
        "ajax": {
            "url": "/Procedures/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            { "data": "Id", "name": "Id" },
            { "data": "ProcedureCategoryName", "name": "ProcedureCategoryName" },
            {
                data: "ProcedureName", "name": "ProcedureName", render: function (data, type, row) {
                    return "<a href='#' onclick=Details('" + row.Id + "');>" + row.ProcedureName + "</a>";
                }
            },
            { "data": "Unit", "name": "Unit" },
