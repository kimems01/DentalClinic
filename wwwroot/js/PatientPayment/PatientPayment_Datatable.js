    ...
    $("#tblPatientPayment").DataTable({
        ...
        "columns": [            
            ...
            },
            {
                data: null, render: function (data, type, row) {
                    if (row.PaidAmount > 0) {
                        return "<a href='#' class='btn btn-success btn-xs' onclick=PrintPaymentReceipt('" + row.PaymentId + "');>Receipt</a>";
                    } else {
                        return "<a href='#' class='btn btn-success btn-xs disabled'>Receipt</a>";
                    }
                }
            },
            {
