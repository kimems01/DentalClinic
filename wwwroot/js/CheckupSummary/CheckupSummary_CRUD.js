...
var SaveCheckup = function (isNewCheckup) {
    ...
    $.ajax({
        ...
        data: PreparedFormObj(isNewCheckup),
        dataType: "json",
...
var PreparedFormObj = function (isNewCheckup) {
    var _CheckupSummaryCRUDViewModel = isNewCheckup
        ? {
            Id: $("#Id").val(),
            VisitId: $("#VisitId").val(),
    ...
    var SendObject = {
        ...
        listCheckupMedicineDetailsCRUDViewModel: isNewCheckup ? null : listMedicineDetails,
        listPatientTestDetailCRUDViewModel: isNewCheckup ? null : listPatientTestDetail
    };
    return SendObject;
}